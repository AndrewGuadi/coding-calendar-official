...
def fetch_data_from_gpt(language, method):
    ...
    prompt = f"Provide a detailed description and example for the method '{method}' in {language}. Each example must include a complete example and clearly defined logic of usage in the specified programming language."
    data = ""
